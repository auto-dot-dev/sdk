...
export const limeGreen = ansi('\x1b[33m')       // links/URLs
export const brown = ansi('\x1b[38;5;180m')    // string values
export const yellowNum = ansi('\x1b[92m')      // numbers and booleans (bright green)
